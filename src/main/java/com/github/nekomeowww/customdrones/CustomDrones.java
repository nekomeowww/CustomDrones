...
@Mod(name="Custom Drones", modid="drones", version="1.6.1-beta.f1", guiFactory="com.github.nekomeowww.customdrones.GuiFactory", acceptedMinecraftVersions="[1.10.2]")
public class CustomDrones
{
  public static final String MODNAME = "Custom Drones";
  public static final String MODID = "drones";
  public static final String VERSION = "1.6.1-beta.f1";
  @Mod.Instance("drones")
